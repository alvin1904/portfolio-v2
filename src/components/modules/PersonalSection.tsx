...
const PersonalSection = () => {
  return (
    <div className="personal_section h-screen flex flex-col items-center justify-center">
      <div className="flex flex-col items-center justify-between personal_container gap-2">
        ...
        <div className="bottom flex flex-col items-center justify-center w-full text-center gap-1">
          <div className="leading-none">2024 Alvin. All Rights Reserved</div>
          ...
          <button className="cto" type="button">
            Tell Me Something!
          </button>
        </div>
      </div>
